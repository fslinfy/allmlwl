...
Ext.define('MyApp.view.main.cpgfkdgl.CpgfdmfhCtrl', {
    ...
    requires: [
        'MyApp.view.main.cpgfkdgl.CpgfdmfhView', 'MyApp.view.main.cpgfkdgl.CpgfdEdit', 'MyApp.view.main.tree.WorkerSelectTree', 'MyApp.view.main.report.PrintCpgfkd'
    ],
    locQuery: function (the) {
        ...
        init: function () {
            ...
            var v = that.viewname.getViewModel();
            v.set('PageTitleName', '商品过车单未过车查询');
