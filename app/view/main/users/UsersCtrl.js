...
Ext.define('MyApp.view.main.users.UsersCtrl',
{
    ...
    requires: [
        'MyApp.view.main.users.UsersView', 'MyApp.view.main.tree.CkmcSelectTree'
    ],
    onBtnQueryClick: function (button, e, options)
        ...
        onFilterChange: function (v)
        {
            ...
            {
                return regExp.test(record.get('username')) || regExp.test(record.get('usercode'));
            });
        },
