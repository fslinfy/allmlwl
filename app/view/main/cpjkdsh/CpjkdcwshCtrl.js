...
Ext.define('MyApp.view.main.cpjkdsh.CpjkdcwshCtrl',
{
    ...
    locQuery: function (the)
        ...
        CpjkdcwshSave: function (loc, the)
        {
            ...
            the.lookupReference('popupCpjkdWindow').down("#btnCpjkdDelete").setHidden(true);
            ...
            else
            {
                ...
                if ((rq < sys_option_min_date) && (ctoday >= sys_option_min_date))
                {
                    Ext.MessageBox.show(
                    {
                        ...
                        {
                            issave = false;
                            the.lookupReference('popupCpjkdWindow').down("#btnCpjkdDelete").setHidden(!sys_system_del);
                            the.lookupReference('popupCpjkdWindow').down("#btnCpjkdSave").setHidden(!sys_system_cwsh);
                            return false;
                        }
                    });
                    return false
