...
Ext.define('MyApp.view.main.cpghkdgl.CpghdlocCtrl', {
    ...
    requires: [
        'MyApp.view.main.cpghkdgl.CpghdlocView', 'MyApp.view.main.showView.CpghkdShowView', 'MyApp.view.main.report.PrintCpghkd'
    ],
    locQuery: function (that) {
        ...
        onCpghdmxShowView: function (button) {
            ...
            if ((((sys_location_id > 0) && (rec.data.khkd == 0)) || ((sys_customer_id > 0) && (rec.data.khkd == 1))) && (rec.data.ztbz > 0)) {
