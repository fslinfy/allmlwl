...
var cpgfdmxStore0;
Ext.define('MyApp.view.main.wxcpgfgl.wxCpgfdcwshCtrl',
{
    extend: 'Ext.app.ViewController',
    alias: 'controller.wxCpgfdcwshCtrl',
    requires: [
        'MyApp.view.main.wxcpgfgl.wxCpgfdcwshView', 
    ...
    locQuery: function (the)
        ...
        init: function ()
        {
            ...
            cpgfdmxStore0.on("load", function ()
            {
                ...
                store.proxy.extraParams.loc = 'wxcpgfdcwsh';
                store.reload();
            });
