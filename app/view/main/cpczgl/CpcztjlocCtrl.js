...
Ext.define("MyApp.view.main.cpczgl.CpcztjlocCtrl", {
    ...
    requires: [
        "MyApp.view.main.jqGridFunction", "MyApp.view.main.QueryToolbarView", 'MyApp.view.main.tree.QueryKhmc', 'MyApp.view.main.tree.QueryCkmc', 'MyApp.view.main.tree.PageTitle', "MyApp.view.main.cpczgl.CpcztjlocView"
    ],
    init: function () {
            that = this;
            ...
            that.control({
                ...
                "#btnQueryKhmc": {
                    click: onSelectKhbmView
                },
                "#btnQueryCkmc": {
                    click: onSelectCkbmView
                }
            });
