Ext.define("MyApp.view.main.tree.CpbmSelectTreePanel",
{
    ...
    },
    {
        ...
        {
            return value ? Ext.String.format('\x3ca href\x3d"http://sencha.com/forum/showthread.php?t\x3d{1}" target\x3d"_blank"\x3e{0}\x3c/a\x3e', value, record.data.threadid) : ""
        }
    }],
    tbar: [
    {
