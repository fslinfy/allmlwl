...
Ext.define('MyApp.view.main.cpghgl.CpghdmxEdit', {
            ...
            items: [{
                ...
                items: [{
                        ...
                        validator: function (value) {
                            var panel = this.up('#cpghdmxedit').getViewModel();
            ...
            items: [
                {
                    ...
                    listeners: {
                        celldblclick: function (grid, row) {
                            ...
                            var p = this.up('#cpghdmxedit').getViewModel();
                            var sl = p.get('mccsl');
                            var zl = p.get('mcczl');
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            editor: {
                                ...
                                maxValue: 999999.999,
                                validator: function (value) {
                                        var customerGrid = this.up('#cpghdmxcw');
                                        ...
                                        return that.sumjs(store, null, this.up('#cpghdmxedit').getViewModel());
                                    },
                                    listeners: {
                ...
                },
                {
                    ...
                    tools: [{
                        ...
                        text: '新增行',
                        icon: "images/add.gif",
                        handler: 'onCpghdjeAddClick'
                    }, {
                        xtype: "button",
                        text: '删除行',
                        icon: "images/delete.gif",
                        handler: 'onCpghdjeDeleteClick',
                        bind: {
                            disabled: '{!cpghdmxje.selection}'
                        }
                    }],
                    columns: [{
                        text: '区',
                        ...
                        editor: {
                            ...
                            listeners: {
                                change: function (field, value) {
                                    var customerGrid = this.up('#cpghdmxje');
                                    var selection = customerGrid.getSelectionModel().getSelection()[0];
                                    var dj = selection.get('dj');
                                    selection.set('je', Math.ceil(value * dj));
                                    var store = customerGrid.getStore();
                                    return that.sumjs(null, store, this.up('#cpghdmxje').up('#cpghdmxedit').getViewModel());
                                }
                            }
                        }
                    }, {
                        ...
                        editor: {
                            ...
                            listeners: {
                                change: function (field, value) {
                                    ...
                                    var store = customerGrid.getStore();
                                    return that.sumjs(null, store, this.up('#cpghdmxedit').getViewModel());
                                }
                            }
                        }
                    }, {
                        ...
                        listeners: {
                            checkChange: function () {
                                var customerGrid = this.up('#cpghdmxje');
                                var store = customerGrid.getStore();
                                that.sumjs(null, store, this.up('#cpghdmxedit').getViewModel());
                            }
                        }
                    }]
                }
    ...
    buttons: [
        "->", {
            ...
            handler: 'onCpghdmxFormSubmit'
        }, {
            text: '放弃',
            icon: "images/close.gif",
            handler: function () {
                this.up("#cpghdmxedit").close();
            }
        }
    ]
});