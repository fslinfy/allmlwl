...
Ext.define('MyApp.view.main.cpghgl.CpghdshCtrl', {
    ...
    requires: [
        'MyApp.view.main.cpghgl.CpghdshView', 'MyApp.view.main.tree.WorkerSelectTree', 'MyApp.view.main.cpghgl.CpghdCtrlFunction', 'MyApp.view.main.report.PrintCpghdgh'
    ],
            ...
            Ext.MessageBox.show({
                ...
                fn: function (btn, text) {
                    if (btn == "yes") {
                        ...
                        AjaxDataSave('cpghdghshsave', loc, encodedString, ghshsaveCallBack, the);
                    }
                }
            });
        }
