...
Ext.define('MyApp.view.main.cpghgl.CpghdckshCtrl', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.CpghdckshCtrl',
    requires: [
        'MyApp.view.main.cpghgl.CpghdckshView', 'MyApp.view.main.tree.WorkerSelectTree', 'MyApp.view.main.cpghgl.CpghdCtrlFunction', 'MyApp.view.main.report.PrintCpghdgh'
    ],
    locQuery: function (that) {
            var v = that.viewname.getViewModel();
            var khid = v.get('khid');
            var ckid = v.get('ckid');
            cpghdmxStore.proxy.extraParams.loc = "cpghdmxcksh";
        ...
        init: function () {
            ...
            cpghdmxStore.on("load", function () {
                ...
                store.proxy.extraParams.loc = 'cpghdcksh';
