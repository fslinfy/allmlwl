sys_DisplayAll = "";
var that;
Ext.define('MyApp.view.main.cpghgl.CpghsplocCtrl', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.CpghsplocCtrl',
    requires: [
        'MyApp.view.main.cpghgl.CpghsplocView'
    ],
    locQuery: function (the) {
            ...
            CpghsplocStore.proxy.extraParams.p_l_id = ckid;
            CpghsplocStore.proxy.extraParams.khid = khid;
            CpghsplocStore.proxy.extraParams.cpid = cpid;
            CpghsplocStore.proxy.extraParams.startdate = d1;
            CpghsplocStore.proxy.extraParams.enddate = d2;
            CpghsplocStore.reload();
        },
