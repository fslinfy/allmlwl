...
Ext.define('MyApp.view.main.cpghgl.CpghdcwshCtrl', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.CpghdcwshCtrl',
    requires: [
        'MyApp.view.main.cpghgl.CpghdcwshView', 
    ...
    locQuery: function (that) {
            ...
            var khid = v.get('khid');
            var ckid = v.get('ckid');
            cpghdmxStore.proxy.extraParams.loc = "cpghdmxcwsh";
        ...
        init: function () {
            ...
            cpghdmxStore.on("load", function () {
                ...
                store.proxy.extraParams.loc = 'cpghdcwsh';
