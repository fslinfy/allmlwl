    ...
    onBtnQueryClick: function (button, e, options)
        ...
        createDialog: function (record)
        {
            ...
            else
            {
                ...
                if (record.pid == 0)
                    if (record.leaf == false) this.lookupReference("btnDeleteButton").setDisabled(true)
            }
        },
        ...
        dataSave: function (obj)
        {
            Ext.Ajax.request(
            {
                ...
                success: function (response)
                {
                    ...
                    if (result.success) this.getView().down("#LeftTree").getStore().reload();
                    else console.log("\u9519\u8bef", "\u6570\u636e\u4fdd\u5b58\u5931\u8d25\uff01")
                }, failure: function ()
                {
                    console.log("\u9519\u8bef", "\u53d1\u751f\u9519\u8bef\uff01")
                }
