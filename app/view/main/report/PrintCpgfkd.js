...
function printcpgfkd(p)
{
    ...
    str = str + '<td style="text-align:right;border:0;width:70;">开单日期:</td><td style="text-align:left;border:0;width:120;" ><strong>' + p.kdrq + p.rq.substr(10, 6) + '</strong></td></tr></table></th></tr>'
    //表头
    ...
    {
        str = str + '<tr><td>' + rec.cdmc + '</td><td>' + rec.xmmc + '</td><td>' + rec.bzmc + '</td><td style="text-align:center;" >' + trim(rec.jldw) + '</td><td style="text-align:right;">' + slrenderer(rec.khsl) + '</td><td  style="text-align:right;">' + slrenderer(rec.khzl) + '</td></tr>'
    })
    str = str + '  <tr><strong><td  style="text-align:center;">汇总 </td><td  style="text-align:left;"  colspan="3"><strong></strong></td><td  style="text-align:right;"><strong>' + slrenderer(p.khsl) + '</strong></td><td style="text-align:right;"><strong>' + slrenderer(p.khzl) + '</strong></td></tr>'
