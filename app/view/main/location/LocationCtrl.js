var that;
Ext.define("MyApp.view.main.location.LocationCtrl",
{
    extend: "Ext.app.ViewController",
    alias: "controller.LocationCtrl",
    requires: ["MyApp.view.main.location.LocationView"],
    onBtnQueryClick: function (button, e, options)
        ...
        onBtnDeleteClick: function (button, e, options)
        {
            ...
            var grid = Ext.getCmp("LocationGrid");
