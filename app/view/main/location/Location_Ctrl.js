...
var editUrl = 'jqgriddata.php?act=customeredit';
var listUrl = "jqgriddata.php?act=customerlist";
var mycolModel;
Ext.define("MyApp.view.main.location.Location_Ctrl",
{
    ...
    onBtnQueryClick: function (button, e, options)
        ...
        init: function ()
        {
            ...
            editUrl = 'jqgriddata.php?act=customeredit';
            listUrl = "jqgriddata.php?act=customerlist";
            gridgrouping = false;
            gridgroupingView = {};
            gridpostData = {
                export: "0",
