...
Ext.define('MyApp.view.main.cpkc.CpkcKhlocCtrl',
{
    ...
    requires: [
        'MyApp.view.main.cpkc.CpkcKhlocView', 'MyApp.view.main.tree.QueryKhmc', 'MyApp.view.main.tree.QueryCdmc', 'MyApp.view.main.tree.QueryCpmc', 'MyApp.view.main.tree.QueryCkmc'
    ],
    locQuery: function ()
        {
