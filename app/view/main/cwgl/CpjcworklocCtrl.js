sys_DisplayAll = "";
var that;
Ext.define('MyApp.view.main.cwgl.CpjcworklocCtrl',
{
    extend: 'Ext.app.ViewController',
    alias: 'controller.CpjcworklocCtrl',
    requires: [
        'MyApp.view.main.cwgl.CpjcworklocView'
    ],
    locQuery: function (the)
        {
            ...
            CpjcworkmxStore.proxy.extraParams.ckid = ckid;
            CpjcworkmxStore.proxy.extraParams.khid = khid;
            CpjcworkmxStore.proxy.extraParams.cpid = cpid;
            CpjcworkmxStore.proxy.extraParams.jclb = jclb;
            CpjcworkmxStore.proxy.extraParams.startdate = d1;
            CpjcworkmxStore.proxy.extraParams.enddate = d2;
            CpjcworkmxStore.reload();
        },
        ...
        init: function ()
        {
            ...
            this.getView().down('#QueryDate').setHidden(false);
            this.locQuery(this);
        },
