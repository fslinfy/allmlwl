sys_DisplayAll = "";
var that;
Ext.define('MyApp.view.main.cwgl.CwjetjCtrl',
{
    extend: 'Ext.app.ViewController',
    alias: 'controller.CwjetjCtrl',
    requires: [
        'MyApp.view.main.cwgl.CwjetjView'
    ],
    locQuery: function (the)
        {
            ...
            var ny = v.get('ny');
            var yu = v.get('yu');
            CwjetjStore.proxy.extraParams.p_l_id = ckid;
            CwjetjStore.proxy.extraParams.khid = khid;
            CwjetjStore.proxy.extraParams.ny = ny;
            CwjetjStore.proxy.extraParams.yu = yu;
            CwjetjStore.reload();
        },
