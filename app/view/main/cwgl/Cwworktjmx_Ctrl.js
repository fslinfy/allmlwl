...
var griddiv = new Ext.Component(
{
    ...
    layout: 'fit',
    bodyPadding: 0,
    html: '<div style="background:red; width:100%;height:100%;padding:0 1 0 1;" id="griddivid' + gridTableName +
        '"> <table id="' + gridTableName + '" style="width:100%;"></table><div id="' + gridTableName +
        'Pager"></div></div>'
});
var fheight = 218;
var paging = false;
...
createpivotgridmx = function (op)
{
    ...
    griddiv = new Ext.Component(
    {
        ...
        layout: 'fit',
        bodyPadding: 0,
        html: '<div style="width:' + w + ';height:' + h + ';padding:0 1 0 1;" id="griddivid' +
            gridTableName + '"> <table id="' + gridTableName + '" style="width:100%;"></table><div id="' +
            gridTableName + 'Pager"></div></div>'
    });
    ...
    var url = 'JQGRIDDATA.php?act=CwworktjmxLIST&loc=&bybz=' + work + "&ny=" + ny + "&yu=" + yu + "&khid=" + khid +
        "&p_l_id=" + ckid + "&bz=&page=1&start=0&limit=25";
