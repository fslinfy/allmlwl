sys_DisplayAll = "";
var that;
Ext.define('MyApp.view.main.cwgl.CwworktjCtrl',
{
    extend: 'Ext.app.ViewController',
    alias: 'controller.CwworktjCtrl',
    requires: [
        'MyApp.view.main.cwgl.CwworktjView'
    ],
    locQuery: function (the)
        {
            ...
            var ny = v.get('ny');
            var yu = v.get('yu');
            CwworktjStore.proxy.extraParams.p_l_id = ckid;
            CwworktjStore.proxy.extraParams.khid = khid;
            CwworktjStore.proxy.extraParams.bz = "";
            CwworktjStore.proxy.extraParams.ny = ny;
            CwworktjStore.proxy.extraParams.yu = yu;
            CwworktjStore.reload();
        },
