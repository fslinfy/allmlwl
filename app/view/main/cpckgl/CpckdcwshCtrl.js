...
Ext.define('MyApp.view.main.cpckgl.CpckdcwshCtrl',
{
    ...
    locQuery: function (that)
        ...
        CpckdshSave: function (loc, the)
        {
            ...
            the.lookupReference('popupCpckdWindow').down("#btnCpckdCancel").setHidden(true);
            ...
            else
            {
                ...
                if ((rq < sys_option_min_date) && (ctoday >= sys_option_min_date))
                {
                    Ext.MessageBox.show(
                    {
                        ...
                        {
                            the.lookupReference('popupCpckdWindow').down("#btnCpckdSave").setHidden(!sys_system_cwsh);
                            the.lookupReference('popupCpckdWindow').down("#btnCpckdDelete").setHidden(!sys_system_del);
                            the.lookupReference('popupCpckdWindow').down("#btnCpckdCancel").setHidden(!sys_system_cwsh);
                            return false;
                        }
                    });
                    return false
