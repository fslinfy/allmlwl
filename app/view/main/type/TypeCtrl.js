Ext.define('MyApp.view.main.type.TypeCtrl',
{
    extend: 'Ext.app.ViewController',
    alias: 'controller.TypeCtrl',
    requires: [
        'MyApp.view.main.type.TypeView'
    ],
    onBtnQueryClick: function (button, e, options)
        ...
        onFilterChange: function (v)
        {
          var store = this.getView().getStore()
            ...
            {
                return regExp.test(record.get('T_name')) || regExp.test(record.get('T_code'));
            });
        }
})